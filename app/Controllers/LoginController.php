...
class LoginController extends BaseController {
	...
	public function login() {
		if($this->request->getMethod() == 'POST') {
			...
			if ($utilisateur) {
				if ($utilisateur['verifie'] == 'f') {
					session()->setFlashdata('error', "Votre compte n'est pas activé");
					return redirect()->to('/login');
	...
	public function register() {
		...
		$message = "Cliquez sur le lien suivant pour activer votre compte : $resetLink";
